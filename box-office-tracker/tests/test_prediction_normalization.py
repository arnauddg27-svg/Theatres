...
class PredictionNormalizationTest(unittest.TestCase):
    ...
    def test_complete_reported_weekend_actuals_do_not_get_historical_residual(self):
        pred = {
            "movie": "Current Movie",
            "seat_mid_m": 81.4,
            "seat_low_m": 78.1,
            ...
            "seat_weighted_coverage_ratio": 1.0,
            "seat_data_quality": 1.0,
            "reported_actual_day_share": 1.0,
            "model_cohort_key": "core,expansion",
            "model_version": predict.MODEL_VERSION,
            "daily_details": {
                day: {
                    "actual_override": True,
                    "domestic_mid": gross * 1_000_000,
                    "effective_coverage_ratio": 1.0,
                }
                for day, gross in {
                    "Thursday": 10.4,
        ...
        self.assertAlmostEqual(81.4, pred["regression_mid_m"], places=6)
        self.assertNotIn("historical_residual_factor", pred)
        self.assertNotIn("historical-residual", pred["regression_source"])
    ...
    def test_same_week_actual_amc_gross_anchor_uses_sampled_revenue_signal(self):
        daily_estimates = {
            "Thursday": 12_000_000.0,
            "Friday": 18_000_000.0,
        }
        daily_details = {
            "Thursday": {
                ...
                "domestic_low": 12_000_000.0,
                "domestic_high": 12_000_000.0,
                "seat_model_actual_scale": 1.0,
                "effective_coverage_ratio": 1.0,
                "sold_seats": 100_000,
                "amc_total": 2_000_000.0,
            },
            "Friday": {
                "actual_override": False,
                "domestic_mid": 18_000_000.0,
                "domestic_low": 16_000_000.0,
                "domestic_high": 20_000_000.0,
                "effective_coverage_ratio": 0.98,
                "daypart_coverage_factor": 1.0,
                "full_day_window_coverage_ratio": 0.0,
                "earliest_showtime_hour": 16.0,
                "sold_seats": 125_000,
                "amc_total": 4_000_000.0,
            },
        }
        cal = {
            "calibration_factors": {
